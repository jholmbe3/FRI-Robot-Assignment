...
def spawn_turtle():
    ...
    try:
        ...
        spawnTurtle(turtle_x, turtle_y, turtle_theta, "runner")
    except:
        pass

def move_turtle():
    ## declares that node is publishing to the '/turtle1/cmd_vel' topic using the message type "Twist".
    turtle_pub = rospy.Publisher('/runner/cmd_vel', Twist, queue_size = 10)
    time.sleep(2)
...
if __name__ == '__main__':
    try:
        ...
        rospy.Subscriber("/runner/pose", Pose, turtlePose)
